    ...
    <div className="min-h-screen bg-hero-gradient flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <Link to="/" className="flex items-center gap-2 z-10">
          ...
          <span className="text-2xl font-bold text-hero-text">Neighborbrite</span>
        </Link>

        <div className="z-10 space-y-6">
          <h1 className="text-4xl xl:text-5xl font-bold text-hero-text leading-tight">
        ...
        <div className="z-10 flex items-center gap-4">
          <div className="flex -space-x-2">
            {["SM", "DC", "ET"].map((initials, i) => (
              <div
                key={i}
                className="w-10 h-10 rounded-full bg-primary/20 border-2 border-hero-text/20 flex items-center justify-center text-hero-text text-sm font-medium"
              >
                {initials}
              </div>
            ))}
          </div>
          <p className="text-hero-text/80 text-sm">
            <span className="font-semibold text-hero-text">5,000+</span> happy customers
          </p>
        </div>
      </div>
